...
8. ビジュアルの書式設定で、**[ビジュアル] > [カテゴリ ラベル]** プロパティを **[オフ]** にします。

    ![画像 103](Linked_image_Files/07-design-report-in-power-bi-desktop_image36b.png)

9. **[全般] >[効果] > [背景色]** プロパティを灰色の薄い網掛けに設定します。
...
13. 前の手順を繰り返し、**Product \| Formatting \| Font Color Format** フィールドを使用して、 **[Color]** フィールドのフォント色の条件付き書式を設定します
    ...
    "背景とフォントの色を、「**Power BI Desktop でのデータの準備**」ラボで **ColorFormats.csv** ファイルから取得し、「**Power BI Desktop にデータを読み込む**」ラボで **Product** クエリに結合したことを思い出してください。"**
...
4. ビジュアルを非表示にするために **[選択項目]** ペインで、**[Sales and Target by Month]**(月別売上高と目標) 項目の横にある、目のアイコンをクリックします。
...
6. ブックマークの名前を変更するために、ブックマークをダブルクリックします。
...
3. ボタンを選択し、 **[書式]** ペインで、 **[ボタン]** をクリックし、 **[スタイル] - [テキスト]** プロパティを **[オン]** にします。
...
5. **[フィル]** セクションを **[オン]** に変更して展開をしてから、補完的な色を使用して背景色を設定します。

6. **[アクション]** プロパティを **[オン]** にします。
...
9. コピーと貼り付けを使用してボタンのコピーを作成し、次のように新しいボタンを構成します。
    ...
    *ヒント:コピーと貼り付けのショートカット コマンドは、**Ctrl+C** キーに続いて **Ctrl+V** キーです。"*
    ...
    - **[テキスト]** プロパティを **[Column Chart]** に設定します
